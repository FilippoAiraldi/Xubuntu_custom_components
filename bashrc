...
################################################################### CUSTOM MODIFICATION ############################################################################
# Add git branch name (master, develop, etc.) to the terminal. 
# Original section is commented below
source ~/.custom-components/git-prompt.sh 
export GIT_PS1_SHOWCOLORHINTS=true 
if [ "$color_prompt" = yes ]; then
     PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;35m\]$(__git_ps1)\[\033[00m\]\$ '
else
     PS1='${debian_debian:+($chroot_chroot)}\u@\h:\w$(__git_ps1)\$ '
fi
